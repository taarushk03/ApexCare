      ...
      if (user?.email) {
        ...
        if (backendUser) {
          ...
          setProfileData(prev => ({
            ...
            medical: {
              bloodType: backendUser.blood_group || '',
            ...
            emergency: {
              ...
              relation: backendUser.emergency_contact_relation || '',
    ...
    try {
      ...
      await fetch(`http://localhost:3001/users/${user?.id}`, {
        ...
        body: JSON.stringify({
          ...
          dob: updatedData.identity.dob,
          phone: updatedData.identity.phone,
          address: updatedData.identity.address,

          blood_group: updatedData.medical.bloodType,
          height: updatedData.medical.height,
          weight: updatedData.medical.weight,
          allergies: updatedData.medical.allergies,

          emergency_contact_name: updatedData.emergency.name,
          emergency_contact_relation: updatedData.emergency.relation,
          emergency_contact_phone: updatedData.emergency.phone,
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div>
                    <div className="flex items-center space-x-2 mb-1">
                      <h2 className="text-2xl font-black text-slate-800 tracking-tight">{profileData.identity.name || `${user?.firstName || ''} ${user?.lastName || ''}`.trim() || 'Anonymous Patient'}</h2>
